...
namespace JinRi.Notify.Frame
{
    ...
    {
        private static readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(WebCache));
        private const string CachePrefix = "JinRi_";

        #region 单例对象实现

        private static readonly ICacheProvider m_providerInstance = new WebCacheProvider();
