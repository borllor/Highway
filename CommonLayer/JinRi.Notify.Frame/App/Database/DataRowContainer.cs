...
namespace JinRi.Notify.Frame
{
    ...
    {
        private readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(DataRowContainer));
        ...
        public object this[DataColumn column] { get { return DataRow[column]; } set { this[column] = value; } }
        ...
        /// </summary>
        /// <param name="columnName">列的从零开始的索引</param>
        /// <returns>如果列不存在或列包含 null 值，则为 true；否则为 false</returns>
        ...
        public bool IsNull(string columnName)
        {
            try
            {
                return !DataRow.Table.Columns.Contains(columnName) || DataRow.IsNull(columnName);
            }
            catch
            {
        ...
        {
            return this.IsNull(columnName) ? defaultValue : Convert.ToString(this[columnName]);
        }
        ...
        public byte Byte(string columnName, byte defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToByte(this[columnName]);
            }
            catch(Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Byte产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public short Short(string columnName, short defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToInt16(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Short产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public int Int(string columnName, int defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToInt32(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Int产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public long Long(string columnName, long defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToInt64(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Long产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public decimal Decimal(string columnName, decimal defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToDecimal(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Decimal产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public double Double(string columnName, double defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToDouble(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Double产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public float Float(string columnName, float defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToSingle(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Float产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public bool Bool(string columnName, bool defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : (bool)this[columnName, true];
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Bool产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        public DateTime DateTime(string columnName, DateTime defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : Convert.ToDateTime(this[columnName]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到DateTime产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        {
            return Enum<T>(columnName, default(T));
        }
        ...
        public T Enum<T>(string columnName, T defaultValue)
        {
            try
            {
                return this.IsNull(columnName) ? defaultValue : (T)this[columnName];
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0},转换到Enum产生异常", columnName), ex);
                return defaultValue;
            }
        }
        ...
        {
            return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToString(this[ccolumnIndex]);
        }
        ...
        public byte Byte(int ccolumnIndex, byte defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToByte(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Byte产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public short Short(int ccolumnIndex, short defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToInt16(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Short产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public int Int(int ccolumnIndex, int defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToInt32(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Int产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public long Long(int ccolumnIndex, long defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToInt64(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Long产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public decimal Decimal(int ccolumnIndex, decimal defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToDecimal(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Decimal产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public double Double(int ccolumnIndex, double defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToDouble(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Double产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public float Float(int ccolumnIndex, float defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToSingle(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Float产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public bool Bool(int ccolumnIndex, bool defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : (bool)this[ccolumnIndex, true];
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Bool产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        public DateTime DateTime(int ccolumnIndex, DateTime defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : Convert.ToDateTime(this[ccolumnIndex]);
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到DateTime产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
        ...
        {
            return Enum<T>(ccolumnIndex, default(T));
        }
        ...
        public T Enum<T>(int ccolumnIndex, T defaultValue)
        {
            try
            {
                return this.IsNull(ccolumnIndex) ? defaultValue : (T)this[ccolumnIndex];
            }
            catch (Exception ex)
            {
                Logger.Error(string.Format("当前行所属列：{0}，列索引：{1},转换到Enum产生异常", DataRow.Table.Columns[ccolumnIndex].ColumnName, ccolumnIndex), ex);
                return defaultValue;
            }
        }
    }
